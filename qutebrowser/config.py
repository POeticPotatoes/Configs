...
sys.path.append('/home/poeticpotato/.config/qtile')
from theme import bar_colors, c1, c2, c3;
...
# Status Bar
c.colors.statusbar.insert.bg = bar_colors[2]
c.colors.statusbar.normal.bg = bar_colors[3]
c.colors.statusbar.url.success.https.fg = 'white'
c.colors.statusbar.url.error.fg = 'orange'
c.statusbar.widgets = ["keypress", "text:  |", 'url', "text:|", "history", ]
...
c.colors.tabs.even.bg = bar_colors[2]
c.colors.tabs.odd.bg = bar_colors[3]
c.colors.tabs.even.fg = c1
c.colors.tabs.odd.fg = c.colors.tabs.even.fg
c.colors.tabs.bar.bg = "#444444"

c.colors.tabs.selected.even.bg = bar_colors[1]
c.colors.tabs.selected.even.fg = c2
c.colors.tabs.selected.odd.bg = c.colors.tabs.selected.even.bg 
c.colors.tabs.selected.odd.fg = c.colors.tabs.selected.even.fg 

c.tabs.padding = {'top': 3, 'bottom': 6, 'left': 10, 'right': 10}
c.tabs.position = 'top'
...
config.bind('<Ctrl-R>', 'config-cycle content.user_stylesheets "' + '" "'.join(stylesheets) + '" ""')
